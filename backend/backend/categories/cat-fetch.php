...
if (!empty($keyword)) {
    $sql = "SELECT * FROM categories WHERE cat_name LIKE '%{$keyword}%' ORDER BY cat_id DESC LIMIT $start, $perPage";
} else {
    $sql = "SELECT * FROM categories ORDER BY cat_id DESC LIMIT $start, $perPage";
}
