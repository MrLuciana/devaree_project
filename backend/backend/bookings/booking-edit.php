...
<div class="modal-body" style="padding: 30px 15px 20px 15px;">
    <div class="row">
        <div class="col">
            ...
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_code']); ?>" type="text" id="code" class="form-control">
        </div>
        <div class="col-8">
            <label for="name">ชื่อบริการ</label>
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_name']); ?>" type="text" id="name" class="form-control">
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            ...
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_price1']); ?>" type="number" id="price1" class="form-control">
        </div>
        <div class="col">
            <label for="price2">ราคา (2 ชม.)</label>
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_price2']); ?>" type="number" id="price2" class="form-control">
        </div>
        <div class="col">
            <label for="price3">ราคา (3 ชม.)</label>
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_price3']); ?>" type="number" id="price3" class="form-control">
        </div>
    </div>
    ...
    <div class="row mt-3 mb-3">
        <div class="col">
            ...
            <input onkeyup="checkNull();" value="<?php echo htmlspecialchars($row['boo_description']); ?>" type="text" id="description" class="form-control">
        </div>
    </div>
...
<div class="modal-footer">
    <button onclick="bookingUpdate('<?php echo htmlspecialchars($id); ?>');" id="btnSubmit"
