...
$id = $_POST['id'];
$sql = "SELECT * FROM course_categories WHERE course_cats_id = '$id'";
...
<div class="modal-body" style="padding: 30px 15px 20px 15px;">
    <div class="row">
        <div class="col">
            ...
            <input onkeyup="checkNull();" value="<?php echo $row['course_cats_name']; ?>" type="text" id="name" class="form-control">
        </div>
    </div>
    ...
    <div class="row mt-3 mb-3">
        <div class="col">
            ...
            <input onkeyup="checkNull();" value="<?php echo $row['course_cats_description']; ?>"
...
<div class="modal-footer">
    <button onclick="course_catsUpdate('<?php echo $id; ?>');" id="btnSubmit"
