<div class="container">
  <div class="page-inner">
    <div class="page-header">
      <h3 class="fw-bold mb-3">หมวดหมู่บริการ</h3>
    </div>
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <button data-toggle="modal" data-target="#IModal"
              onclick="service_catsModalForm('เพิ่มหมวดหมู่บริการ')" type="button"
              ...
              <ul class="nav" style="display: flex; justify-content: flex-end; align-items: center; margin-right: 10px;">
                <li class="nav-item" style="display: flex; align-items: center;">
                  ...
                  <button class="btn btn-primary" id="btnSearch"
                    ...
                    onclick="service_catsList(page)">ค้นหา</button>
        ...
        <div class="card-body" id="service_catsTables"></div>
      </div>
    </div>
  </div>
</div>
...
<?php
include('service-categories/service_cats-action.php');
$conn->close();
?>