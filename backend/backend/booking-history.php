<div class="container">
  <div class="page-inner">
    <div class="page-header">
      <h3 class="fw-bold mb-3">ประวัติการใช้งาน</h3>
    </div>
    <div class="col-md-12">
      <div class="card">
              ...
              <ul class="nav" style="display: flex; justify-content: flex-end; align-items: center; margin-right: 10px;">
                <li class="nav-item" style="display: flex; align-items: center;">
                  ...
                  <button class="btn btn-primary" id="btnSearch"
                    ...
                    onclick="payment2List(page)">ค้นหา</button>
        ...
        <div class="card-body" id="payment2Tables"></div>
      </div>
    </div>
  </div>
</div>
...
<?php
include('payments/payment2-action.php');
$conn->close();
?>